...
const baseURL = (meta?.['env']?.VITE_API_URL as string | undefined) || 'http://localhost:4000';
...
async function request<T = any>(
  ...
  const token = typeof localStorage !== 'undefined' ? localStorage.getItem('crystal_jwt') : null;

    ...
    <form onSubmit={handleSubmit(onSubmit)} className={`space-y-4 ${className}`}>
      ...
      <div>
        ...
        <input
          ...
          {...register('full_name')}
          className="w-full px-3 py-2 rounded bg-slate-800 border border-slate-700 text-white placeholder-slate-400 focus:outline-none focus:border-blue-500 focus-visible:ring-2 focus-visible:ring-blue-400 text-sm disabled:opacity-50"
        />
        {errors.full_name && (
      ...
      <div>
        ...
        <select
          ...
          className="w-full px-3 py-2 rounded bg-slate-800 border border-slate-700 text-white focus:outline-none focus:border-blue-500 focus-visible:ring-2 focus-visible:ring-blue-400 text-sm disabled:opacity-50"
        >

        ...
        <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-2">
          ...
          <div className="flex items-center space-x-4">
            ...
            <a
              ...
              className="inline-flex items-center space-x-1.5 text-slate-400 hover:text-blue-400 transition-colors"
            >
        ...
        <div className="md:hidden border-t border-slate-800 bg-slate-900 px-4 pt-3 pb-6 space-y-3">
          {navItems.map((item) => (
            ...
            >
              <span>{item.label}</span>
              {item.badge && (
                <span className="px-2 py-0.5 rounded text-xs bg-blue-500/20 text-blue-300 font-semibold">
                  {item.badge}
                </span>
              )}
            </NavLink>

    ...
    <footer className="bg-slate-950 text-slate-400 border-t border-slate-800 text-sm">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 text-center sm:text-left">
          ...
          <div className="flex items-center space-x-3 p-3 rounded-xl bg-slate-950/60 border border-slate-800">
            ...
            <div>
              ...
              <div className="text-[11px] text-slate-400">FSSA License #{org.license_number}</div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3 p-3 rounded-xl bg-slate-950/60 border border-slate-800">
            ...
            <div>
              ...
              <div className="text-[11px] text-slate-400">Indiana Pathways Approved</div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <span className="text-[10px] uppercase font-bold text-blue-400 tracking-wider">
                Indiana Home Care Division
              </span>
            </div>
          </div>

          <p className="text-xs leading-relaxed text-slate-400">
            Dedicated to providing dignified, person-centered in-home care support across Central Indiana. Empowering seniors and individuals with physical disabilities to live safely and independently.
          </p>
          ...
          <div className="p-3.5 rounded-xl bg-slate-900 border border-slate-800 space-y-1">
            ...
            <a
              ...
              className="text-base font-bold text-white hover:text-blue-300 transition-colors block"
            >
              {org.contact_phone}
            </a>
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-xs">
            <li>
              <Link to="/services#attendant-care" className="hover:text-blue-400 transition-colors flex items-center justify-between group">
                <span>Attendant Care Services (ATTC)</span>
                <span className="text-slate-600 group-hover:text-blue-400 transition-colors">&rarr;</span>
              </Link>
            </li>
            <li>
              <Link to="/services#homemaker-care" className="hover:text-blue-400 transition-colors flex items-center justify-between group">
                <span>Homemaker & Companion Care</span>
                <span className="text-slate-600 group-hover:text-blue-400 transition-colors">&rarr;</span>
              </Link>
            </li>
            <li>
              <Link to="/services#memory-care" className="hover:text-blue-400 transition-colors flex items-center justify-between group">
                <span>Memory & Dementia Assistance</span>
                <span className="text-slate-600 group-hover:text-blue-400 transition-colors">&rarr;</span>
              </Link>
            </li>
            <li>
              <Link to="/services#respite-care" className="hover:text-blue-400 transition-colors flex items-center justify-between group">
                <span>Family Caregiver Respite Relief</span>
                <span className="text-slate-600 group-hover:text-blue-400 transition-colors">&rarr;</span>
              </Link>
            </li>
            <li>
              <Link to="/services#structured-family" className="hover:text-blue-400 transition-colors flex items-center justify-between group">
                <span>Structured Family Caregiving (SFC)</span>
                <span className="text-slate-600 group-hover:text-blue-400 transition-colors">&rarr;</span>
              </Link>
            </li>
          </ul>
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-xs">
            <li>
              <Link to="/caregiver/portal" className="hover:text-blue-400 transition-colors flex items-center gap-1.5 font-medium text-slate-300">
                <span className="w-1.5 h-1.5 rounded-full bg-blue-400"></span>
                <span>Caregiver Onboarding Portal</span>
              </Link>
            </li>
            <li>
              <Link to="/portal/client" className="hover:text-blue-400 transition-colors flex items-center gap-1.5 font-medium text-slate-300">
                <span className="w-1.5 h-1.5 rounded-full bg-teal-400"></span>
                <span>Client & Family Care Portal</span>
              </Link>
            </li>
            <li>
              <Link to="/clients" className="hover:text-blue-400 transition-colors flex items-center gap-1.5 font-medium text-slate-300">
                <span className="w-1.5 h-1.5 rounded-full bg-purple-400"></span>
                <span>Staff Client Operations & Auths</span>
              </Link>
            </li>
            <li>
              <Link to="/admin" className="hover:text-blue-400 transition-colors flex items-center gap-1.5 font-medium text-slate-300">
                <span className="w-1.5 h-1.5 rounded-full bg-amber-400"></span>
                <span>Multi-State Command Center</span>
              </Link>
            </li>
            <li>
              <Link to="/apply" className="inline-flex items-center gap-1 text-blue-400 hover:text-blue-300 font-bold transition-colors mt-1">
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2.5 text-xs">
            <li className="flex items-start space-x-2.5">
              ...
              <span>
                {org.office_address?.street}, Suite 100<br />
      ...
      <div className="border-t border-slate-800/80 bg-black/60 py-5 px-4 text-xs text-slate-400">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-3">
          <div>
            <p>© {currentYear} {org.name}. Licensed Indiana Home Care Provider.</p>
            <p className="text-[11px] text-slate-400 mt-0.5">
              Protected Health Information (PHI) encrypted and safeguarded under HIPAA Security Rule (45 CFR § 164.312).
            </p>
          </div>
          <div className="flex flex-wrap gap-4 text-[11px] text-slate-400">
            <Link to="/contact" className="hover:text-blue-400 transition-colors">Notice of Privacy Practices</Link>
            <span>•</span>
            <Link to="/contact" className="hover:text-blue-400 transition-colors">Terms of Service</Link>
            <span>•</span>
            <Link to="/contact" className="hover:text-blue-400 transition-colors">Non-Discrimination Policy</Link>
          </div>
        </div>
      </div>
    </footer>

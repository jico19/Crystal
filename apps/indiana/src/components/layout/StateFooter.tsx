      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2.5 text-xs">
            <li>
              <Link to="/login" className="hover:text-blue-400 transition-colors flex items-center gap-1.5 font-medium text-slate-300">
                <span className="w-1.5 h-1.5 rounded-full bg-blue-400"></span>
                <span>Secured Care Portal Login</span>
              </Link>
            </li>
            <li>
              <Link to="/apply" className="inline-flex items-center gap-1 text-blue-400 hover:text-blue-300 font-bold transition-colors">

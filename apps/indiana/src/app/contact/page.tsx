...
export default function IndianaContactPage() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <Badge variant="default" className="text-xs uppercase tracking-wider px-3 py-1 mb-4">
            Indiana Office & Inquiries
          </Badge>
          <h1 className="text-4xl font-extrabold text-gray-900 tracking-tight">
            Contact Cherish Open Arms
          </h1>
          <p className="text-lg text-gray-600 mt-4">
            Connect directly with our Indianapolis care coordination team to discuss in-home care services, waiver programs, or career opportunities.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          {/* Office Info */}
          <div className="lg:col-span-5 space-y-8 bg-blue-50/50 p-8 rounded-3xl border border-blue-100">
            <h3 className="text-2xl font-bold text-gray-900">Indianapolis Headquarters</h3>
            ...
            <div className="p-4 bg-white rounded-2xl border border-blue-200 text-xs text-gray-600 flex items-center gap-3">
              <ShieldCheck className="w-5 h-5 text-primary shrink-0" />
              <span>Indiana FSSA Regulated Agency License #{org.license_number}</span>
            </div>
          </div>

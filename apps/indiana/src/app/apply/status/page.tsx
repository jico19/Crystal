...
function IndianaApplyStatusContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">Cherish Open Arms — Indiana</p>
            </div>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8 rounded-2xl border border-blue-200 bg-blue-50/50 p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h3 className="text-base font-bold text-blue-950">Next Step: Upload Required Credentials</h3>
            ...
            href={`/apply/documents?user_id=${encodeURIComponent(
              searchParams.get('user_id') ||
                (typeof window !== 'undefined'
                  ? localStorage.getItem('crystal_caregiver_guest_id_in') || ''
                  : '') ||
                'in-caregiver-demo-01'
            )}`}
            className="inline-flex shrink-0 items-center gap-2 rounded-xl bg-blue-700 px-5 py-2.5 text-xs font-bold text-white hover:bg-blue-800 transition-colors shadow-sm"
          >
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          ...
          <a href={`tel:${org.contact_phone}`} className="text-primary font-medium hover:underline">
            {org.contact_phone}
          </a>
        </div>
      </div>
...
export default function IndianaApplyStatusPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">

              ...
              <div className="bg-neutral-50 p-4 rounded-xl border border-neutral-200">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs text-neutral-700">
                  <div className="flex items-center gap-1.5">
                    <span className={client.care_needs?.mobility_assistance ? 'text-emerald-700 font-bold' : 'text-neutral-500 font-medium'}>
                      {client.care_needs?.mobility_assistance ? '✓ Yes' : '✕ No'}
                    </span>
                    Mobility Assistance
                  </div>
                  <div className="flex items-center gap-1.5">
                    <span className={client.care_needs?.bathing_dressing ? 'text-emerald-700 font-bold' : 'text-neutral-500 font-medium'}>
                      {client.care_needs?.bathing_dressing ? '✓ Yes' : '✕ No'}
                    </span>
                    Bathing / Dressing
                  </div>
                  <div className="flex items-center gap-1.5">
                    <span className={client.care_needs?.meal_prep ? 'text-emerald-700 font-bold' : 'text-neutral-500 font-medium'}>
                      {client.care_needs?.meal_prep ? '✓ Yes' : '✕ No'}
                    </span>
                    Meal Preparation
                  </div>
                  <div className="flex items-center gap-1.5">
                    <span className={client.care_needs?.medication_reminders ? 'text-emerald-700 font-bold' : 'text-neutral-500 font-medium'}>
                      {client.care_needs?.medication_reminders ? '✓ Yes' : '✕ No'}
                    </span>

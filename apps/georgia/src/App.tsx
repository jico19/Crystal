      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 sm:p-10 shadow-2xl space-y-8 text-center max-w-2xl mx-auto">
        ...
        <div className="pt-2 flex flex-col sm:flex-row justify-center items-center gap-3">
          <Link
            ...
            className="inline-flex items-center space-x-2 px-6 py-3 rounded-lg text-white text-xs font-semibold shadow-lg hover:brightness-110 transition-all cursor-pointer"
          >
            <span>Proceed to Caregiver Onboarding Portal</span>
            <ArrowRight className="w-4 h-4" />
          </Link>

          <Link
            to="/"
            className="inline-flex items-center space-x-2 px-5 py-3 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-semibold border border-slate-700 transition-colors cursor-pointer"
          >

    ...
    try {
      ...
      if (profRes.status === 'fulfilled' && profRes.value.data) {
        ...
        setSelectedClient({
          ...
          care_needs: {},
          payer_details: {
            payer_name: 'Medicaid CCSP',
            plan_type: 'CCSP Waiver',
          },
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 animate-fade-in text-white">
      ...
      <DashboardPageHeader
        ...
        subtitle="Georgia CCSP / SOURCE Medicaid authorizations, clinical intake pipeline, and real-time 15-minute unit burndown."
        icon={Users}

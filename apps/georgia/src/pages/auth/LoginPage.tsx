    ...
    <div className="py-12 px-4 sm:px-6 max-w-md mx-auto space-y-8">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-xs text-slate-400">
          Sign in to access your shifts, EVV documentation, or care plans.
        </p>
      </div>
      ...
      <div className="p-6 sm:p-8 rounded-2xl bg-slate-900 border border-slate-800 shadow-xl space-y-6">
        {msg && (
          <div className="p-3 rounded-lg bg-teal-500/10 border border-teal-500/30 text-teal-300 text-xs">
            {msg}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 rounded-lg bg-slate-950 border border-slate-800 text-white text-xs placeholder-slate-600 focus:outline-none focus:border-teal-500"
            />
          </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <a href="#forgot" className="text-[11px] text-teal-400 hover:underline">
                Forgot?
              </a>
            </div>
            <input

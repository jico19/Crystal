...
interface GeorgiaAuthorizationsClientProps {
  orgId: string;
}

export function GeorgiaAuthorizationsClient({ orgId }: GeorgiaAuthorizationsClientProps) {
  ...
  if (loading) {
    return (
      <div className="py-20 text-center text-slate-500">
        ...
        <p className="text-sm">Loading Georgia Prior Authorizations...</p>
      </div>
    );
  }
  ...
  return (
    <ClientAuthorizationsList
      clientId="cli-001"
      clientName="With Open Hands • Active Client Authorizations"
      orgId={orgId}

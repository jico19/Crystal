...
interface GeorgiaDocumentsClientProps {
  orgId: string;
}

export function GeorgiaDocumentsClient({ orgId }: GeorgiaDocumentsClientProps) {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      console.warn('[GeorgiaDocumentsClient] fetch error:', err);
    } finally {
      setLoading(false);
    }

...
interface GeorgiaLessonClientProps {
  moduleId: string;
}

export function GeorgiaLessonClient({ moduleId }: GeorgiaLessonClientProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-4 border-b pb-4 mb-4">
          <div>
            <span className="text-xs font-semibold px-2.5 py-0.5 rounded-full bg-teal-100 text-teal-800 uppercase tracking-wider">
